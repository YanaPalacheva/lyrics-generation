...
def evaluate_grammar(evaluation_dir, results_dir, allow_typos, parser, combined):
    ...
    for filename in os.listdir(evaluation_dir):
        ...
        score = get_grammar_score(evaluation_dir+filename, allow_typos, parser, combined)
